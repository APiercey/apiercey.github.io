...
date: 2023-04-28
description: What an event store is, what responsibilities is has in an event sourcing system, and building the first component with DynamoDB.
...
The article is meant to be read along with _Aggregate Persistence_.

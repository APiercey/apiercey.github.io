...
Golang is a hit topic for my team and I. We have chosen to incorporate the language into our toolbox to build better software in the neo-Banking domain.
...
### Item
A document are stored as _an Item_.

### Collection
Many Items are stored in _a Collection_.

### Language
Interacting with the database uses _Command-Oriented_ language. Inspired by [Redis](https://redis.io/commands).
